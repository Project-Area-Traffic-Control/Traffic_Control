...
class MainWindow(Toplevel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dashboard_btn.place(x=0, y=133.0, width=200.0, height=47.0)
        ...
        self.rooms_btn.place(x=0, y=183.0, width=200.0, height=47.0)
        
        button_image_3 = PhotoImage(file=relative_to_assets("button_setting.png"))
        ...
        self.reservations_btn.place(x=0.0, y=233.0, width=200.0, height=47.0)
        ...
        #     relief="flat",
        # )
        # self.guests_btn.place(x=0.0, y=283.0, width=200.0, height=47.0)
        ...
        self.current_window.place(x=200, y=72, width=1013.0, height=506.0)
